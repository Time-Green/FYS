class Tile extends BaseObject
{
	...
	// collection of what mining and generating a cave have in common so we dont copypaste it everywhere
	void breakTile()
	{
		destroyed = true;
		density = false;
	...
	void addAesthetics()
	{
		...
		// again we dont need airdecals or decals for those who dont want it
