//modified version of http://www.jeffreythompson.org/collision-detection/

public static class CollisionHelper
{
	// POINT/POINT
	static boolean pointPoint(float x1, float y1, float x2, float y2)
	{
	...
	// RECTANGLE/RECTANGLE PVector overload
	static boolean rectRect(PVector rect1Pos, PVector rect1Size, PVector rect2Pos, PVector rect2Size)
	{
		return rectRect(rect1Pos.x, rect1Pos.y, rect1Size.x, rect1Size.y, rect2Pos.x, rect2Pos.y, rect2Size.x, rect2Size.y);
	}
	...
	// POLYGON/CIRCLE
	static boolean polygonCircle(PVector[] vertices, float cx, float cy, float r)
	{
		// go through each of the vertices, plus
		// the next vertex in the list
		int next = 0;
	...
	// POLYGON/RECTANGLE
	static boolean polygonRect(PVector[] vertices, float rx, float ry, float rw, float rh)
	{
	...
	// POLYGON/LINE
	static boolean polygonLine(PVector[] vertices, float x1, float y1, float x2, float y2)
	{
		// go through each of the vertices, plus the next
		// vertex in the list
		int next = 0;
	...
	// POLYGON/POLYGON
	static boolean polygonPolygon(PVector[] p1, PVector[] p2)
	{
		// go through each of the vertices, plus the next
		// vertex in the list
		int next = 0;
		...
		for (int current = 0; current < p1.length; current++)
		{
			...
			boolean collision = polygonLine(p2, vc.x, vc.y, vn.x, vn.y);
	...
	// TRIANGLE/POINT
	static boolean trianglePoint(float x1, float y1, float x2, float y2, float x3, float y3, float px, float py)
	{
